...
function li(e) {
  ;(j(e) ? os.push(...e) : on && e.id === -1 ? on.splice(Xn + 1, 0, e) : e.flags & 1 || (os.push(e), (e.flags |= 1)),
    Ju())
}
  ...
  for (let T = 0; T < n.length; T++) {
    ...
    if (I.type === 6) {
      ...
      if (xe) {
        ...
        ;(!i && tt.forEach(x),
          q && L && !at(L) ? O(wt(tt, l)) : f.push(...tt),
          nt && (a.push(I), yt(nt) && Qh.set(I, nt)))
      ...
      St(H)
        ...
        .then(
          () => (
            ...
            (H = Eo(Ce, 'beforeRouteEnter', M, K, C)),
            H.push(g),
            St(H)
          ),
        )
