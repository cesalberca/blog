...
summary: In this article, we will explore setting up a new Angular project with SSR (Server-Side Rendering) and see what new configurations it brings. In the following tutorial, we will learn how to enhance the default configuration and add other development tools.
---
