...
locale: en
image: desert.jpg
summary: You want to change [Karma](https://karma-runner.github.io/latest/index.html) in an Angular application to a better test runner like [Jest](https://jestjs.io/)? Then this tutorial is the one you were looking for!
---
