...
export const metadata = {
  title: 'Tabaiba — App móvil de alta calidad con DDD',
  slug: 'tabaiba',
  date: '2025-03-15',
  image: 'tabaiba.jpg',
  summary:
    'Una aplicación móvil que ofrece tres personas nuevas a conocer cuidadosamente seleccionadas cada viernes, centrándose en conexiones sociales auténticas e intencionales.',
}
...
export function useOnboarding() {
  ...
  const onboardingRepository = container.resolve<OnboardingRepository>(InjectionTokens.ONBOARDING_REPOSITORY)
