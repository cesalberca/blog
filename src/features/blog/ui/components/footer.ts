      ...
      <div class="wrapper">
        ...
        <section class="info">
          <small class="copy"
            ...
            <app-link to="https://blog.cleancoder.com/uncle-bob/2012/08/13/the-clean-architecture.html" external
              >Clean Architecture</app-link
            >.</small
          >
          <small class="coverage"
            >${subscribe(this.coverageLiteral)}<span class="coverage-percentage"></span>${this.coverage}%</small
          >
        </section>
      </div>
    </footer>`
