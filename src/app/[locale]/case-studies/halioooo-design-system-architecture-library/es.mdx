...
export const metadata = {
  title: 'Halioooo — Creando un Sistema de Diseño y Biblioteca de Arquitectura',
  slug: 'halioooo-sistema-de-diseno-biblioteca-de-arquitectura',
  date: '2025-04-01',
  image: 'halioooo.png',
  summary:
    'Cómo la implementación de Casos de Uso y Sistemas de Diseño puede transformar la eficiencia organizacional, la mantenibilidad y la consistencia en el desarrollo de software en Halioooo.',
}
