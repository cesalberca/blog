...
export const metadata = {
  ...
  summary:
    'Cómo ayudé a Lightspace a desarrollar Aplicaciones y Funciones de Shopify siguiendo las mejores prácticas, creando plantillas para un desarrollo escalable e implementando pipelines CI/CD para pruebas y despliegue.',
}
...
1. **Mayor eficiencia de desarrollo**: Las plantillas y los _pipelines_ CI/CD redujeron el tiempo de configuración y garantizaron la consistencia.
...
export default function MDXContent({ children }) {
  return <CaseStudyLayout slug="lightspace-shopify-best-practices">{children}</CaseStudyLayout>
}
