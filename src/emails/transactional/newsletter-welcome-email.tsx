...
Great, thank you very much! You'll be now receiving recurrent emails from me about **Frontend Architecture**. While I type away the next newsletter, you can read previous [newsletters here](https://cesalberca.com/newsletter).
`}</MarkdownEmail>
    </EmailTemplate>
  )
}
