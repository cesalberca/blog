...
export const metadata = {
  ...
  slug: 'my-twelve-favorite-problems',
  readTime: 5,
  date: '2023-09-13',
  image: 'my-twelve-favorite-problems/leaf.jpg',
  categories: ['personal-development'],
  summary: 'I concocted my own list of my favorite problems, which I want to share with you.',
}
...
export default function Page({ children }) {
  return <PostLayout slug="my-twelve-favorite-problems">{children}</PostLayout>
}
