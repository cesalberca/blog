import {
  ...
  v as Jt,
  x as eo,
} from './vue-BITYyB3i.js'
const to = ['top', 'right', 'bottom', 'left'],
  Ye = ['start', 'end'],
  Xe = to.reduce((e, t) => e.concat(t, t + '-' + Ye[0], t + '-' + Ye[1]), []),
  de = Math.min,
  K = Math.max,
...
function vt(e) {
  return typeof e != 'number' ? ao(e) : { top: e, right: e, bottom: e, left: e }
}
function ie(e) {
...
function Ue(e, t, o) {
  ...
  const s = Q(t),
    ...
    l = E(t),
    d = s === 'y',
    c = i.x + i.width / 2 - n.width / 2,
    p = i.y + i.height / 2 - n.height / 2,
    u = i[a] / 2 - n[a] / 2
  let h
  switch (l) {
    case 'top':
      h = { x: c, y: i.y - n.height }
      break
    case 'bottom':
      h = { x: c, y: i.y + i.height }
      break
    case 'right':
      h = { x: i.x + i.width, y: p }
      break
...
const lo = async (e, t, o) => {
  const { placement: i = 'bottom', strategy: n = 'absolute', middleware: s = [], platform: r } = o,
    a = s.filter(Boolean),
...
async function Pe(e, t) {
  ...
  const { x: i, y: n, platform: s, rects: r, elements: a, strategy: l } = e,
    ...
    f = vt(h),
    w = a[u ? (p === 'floating' ? 'reference' : 'floating') : p],
    g = ie(
    ...
    v = p === 'floating' ? { x: i, y: n, width: r.floating.width, height: r.floating.height } : r.reference,
    $ = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(a.floating)),
    b = (await (s.isElement == null ? void 0 : s.isElement($)))
...
const po = e => ({
  ...
  async fn(t) {
    ...
    const p = vt(c),
      ...
      b = s.reference[f] + s.reference[h] - u[h] - s.floating[f],
      _ = u[h] - s.reference[h],
      z = await (r.getOffsetParent == null ? void 0 : r.getOffsetParent(d))
    let S = z ? z[$] : 0
    ...
    const M = b / 2 - _ / 2,
      ...
      T = S / 2 - m[f] / 2 + M,
      ee = Re(C, T, H),
      F = !l.arrow && L(n) != null && T !== ee && s.reference[f] / 2 - (T < C ? x : P) - m[f] / 2 < 0,
      R = F ? (T < C ? T - C : T - H) : 0
    return { [h]: u[h] + R, data: { [h]: ee, centerOffset: T - ee - R, ...(F && { alignmentOffset: R }) }, reset: F }
  },
})
function co(e, t, o) {
  return (e ? [...o.filter(n => L(n) === e), ...o.filter(n => L(n) !== e)] : o.filter(n => E(n) === n)).filter(n =>
    e ? L(n) === e || (t ? ye(n) !== n : !1) : !0,
  )
}
const ho = function (e) {
    return (
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          const { rects: s, middlewareData: r, placement: a, platform: l, elements: d } = t,
            { crossAxis: c = !1, alignment: p, allowedPlacements: u = Xe, autoAlignment: h = !0, ...f } = J(e, t),
            m = p !== void 0 || u === Xe ? co(p || null, h, u) : u,
            w = await Pe(t, f),
            g = ((o = r.autoPlacement) == null ? void 0 : o.index) || 0,
            v = m[g]
          if (v == null) return {}
          const $ = wt(v, s, await (l.isRTL == null ? void 0 : l.isRTL(d.floating)))
          if (a !== v) return { reset: { placement: m[0] } }
          const b = [w[E(v)], w[$[0]], w[$[1]]],
            _ = [...(((i = r.autoPlacement) == null ? void 0 : i.overflows) || []), { placement: v, overflows: b }],
            z = m[g + 1]
          if (z) return { data: { index: g + 1, overflows: _ }, reset: { placement: z } }
          const S = _.map(x => {
              const P = L(x.placement)
              return [
                x.placement,
                P && c ? x.overflows.slice(0, 2).reduce((C, H) => C + H, 0) : x.overflows[0],
                x.overflows,
              ]
            }).sort((x, P) => x[1] - P[1]),
            A =
              ((n = S.filter(x => x[2].slice(0, L(x[0]) ? 2 : 3).every(P => P <= 0))[0]) == null ? void 0 : n[0]) ||
              S[0][0]
          return A !== a ? { data: { index: g + 1, overflows: _ }, reset: { placement: A } } : {}
        },
      }
    )
  },
  uo = function (e) {
    return (
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          var o, i
          const { placement: n, middlewareData: s, rects: r, initialPlacement: a, platform: l, elements: d } = t,
            {
              mainAxis: c = !0,
              crossAxis: p = !0,
          ...
          const g = E(n),
            v = Q(a),
            $ = E(a) === a,
            b = await (l.isRTL == null ? void 0 : l.isRTL(d.floating)),
            _ = u || ($ || !m ? [$e(a)] : no(a)),
            z = f !== 'none'
          !u && z && _.push(...ro(a, m, f, b))
          const S = [a, ..._],
            M = await Pe(t, w),
            A = []
          ...
          if (((x = [...x, { placement: n, overflows: A }]), !A.every(T => T <= 0))) {
            var P, C
            const T = (((P = s.flip) == null ? void 0 : P.index) || 0) + 1,
              ee = S[T]
            if (ee) return { data: { index: T, overflows: x }, reset: { placement: ee } }
            let F =
              (C = x.filter(R => R.overflows[0] <= 0).sort((R, j) => R.overflows[1] - j.overflows[1])[0]) == null
                ? void 0
                : C.placement
            if (!F)
              switch (h) {
                case 'bestFit': {
                  ...
                  const R =
                    (H = x
                      .filter(j => {
                        if (z) {
                          const W = Q(j.placement)
                          return W === v || W === 'y'
                        }
                        return !0
                      })
                      .map(j => [j.placement, j.overflows.filter(W => W > 0).reduce((W, Wt) => W + Wt, 0)])
    ...
    return (
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          const m = a.fn({ ...t, [u]: h, [p]: f })
          return { ...m, data: { x: m.x - o, y: m.y - i, enabled: { [u]: s, [p]: r } } }
        },
      }
    )
  },
      ...
      e === void 0 && (e = {}),
      {
        ...
        async fn(t) {
          ...
          p === 'top' || p === 'bottom'
            ? ((w = p),
              (g =
                u === ((await (r.isRTL == null ? void 0 : r.isRTL(a.floating))) ? 'start' : 'end') ? 'left' : 'right'))
            : ((g = p), (w = u === 'end' ? 'top' : 'bottom'))
          ...
          let S = b,
            M = _
          if (
            ((o = t.middlewareData.shift) != null && o.enabled.x && (M = $),
            ...
            const x = K(c.left, 0),
              ...
              H = K(c.bottom, 0)
            h
              ? (M = f - 2 * (x !== 0 || P !== 0 ? x + P : K(c.left, c.right)))
              : (S = m - 2 * (C !== 0 || H !== 0 ? C + H : K(c.top, c.bottom)))
          }
          await l({ ...t, availableWidth: M, availableHeight: S })
          const A = await r.getDimensions(a.floating)
          return f !== A.width || m !== A.height ? { reset: { rects: !0 } } : {}
        },
      }
    )
  }
...
function pe(e, t, o, i) {
  ...
  const d = a ? O(a) : window,
    c = !xt() && o
  let p = (r.left + ((c && ((n = d.visualViewport) == null ? void 0 : n.offsetLeft)) || 0)) / l.x,
    u = (r.top + ((c && ((s = d.visualViewport) == null ? void 0 : s.offsetTop)) || 0)) / l.y,
    h = r.width / l.x,
    f = r.height / l.y
  if (a) {
    const m = O(a),
...
function Pt(e) {
  const t = ce(e)
  return Ve(t) ? t.ownerDocument.body : D(t) && Ae(t) ? t : Pt(t)
}
function xe(e, t) {
  var o
  t === void 0 && (t = [])
...
function et(e) {
  const t = O(e)
  let o = Je(e)
  for (; o && vo(o) && B(o).position === 'static'; ) o = Je(o)
  return o && (X(o) === 'html' || (X(o) === 'body' && B(o).position === 'static' && !Be(o)))
    ? t
    : o ||
        (function (i) {
          let n = ce(i)
...
const $o = {
      ...
      const s =
          o === 'clippingAncestors'
            ? (function (d, c) {
                const p = c.get(d)
                if (p) return p
                let u = xe(d).filter(w => G(w) && X(w) !== 'body'),
                  h = null
        ...
        l = r.reduce(
          (d, c) => {
            const p = Qe(t, c, n)
            return (
              (d.top = ne(p.top, d.top)),
              (d.right = Ke(p.right, d.right)),
              (d.bottom = Ke(p.bottom, d.bottom)),
              (d.left = ne(p.left, d.left)),
              d
            )
          },
          Qe(t, a, n),
    ...
    getDimensions: function (e) {
      return D(e) ? yt(e) : e.getBoundingClientRect()
    },
    getOffsetParent: et,
    ...
    async getElementRects(e) {
      ...
      const n = this.getOffsetParent || et,
        s = this.getDimensions
      return { reference: yo(t, await n(o), i), floating: { x: 0, y: 0, ...(await s(o)) } }
    },
  ...
  _o = (e, t, o) => {
    const i = new Map(),
      n = { platform: $o, ...o },
      s = { ...n.platform, _c: i }
    return lo(e, t, { ...n, platform: s })
  }
function At(e, t) {
  for (const o in t)
    Object.prototype.hasOwnProperty.call(t, o) && (typeof t[o] == 'object' && e[o] ? At(e[o], t[o]) : (e[o] = t[o]))
}
const N = {
  disabled: !1,
  distance: 5,
...
function xo(e) {
  const t = [e]
  let o = N.themes[e] || {}
  do o.$extend && !o.$resetCss ? (t.push(o.$extend), (o = N.themes[o.$extend] || {})) : (o = null)
  while (o)
...
function tt(e) {
  const t = [e]
  let o = N.themes[e] || {}
  do o.$extend ? (t.push(o.$extend), (o = N.themes[o.$extend] || {})) : (o = null)
  while (o)
  return t
}
let oe = !1
...
const Ot = ['auto', 'top', 'bottom', 'left', 'right'].reduce((e, t) => e.concat([t, `${t}-start`, `${t}-end`]), []),
  ot = { hover: 'mouseenter', focus: 'focus', click: 'click', touch: 'touchstart', pointer: 'pointerdown' },
  it = { hover: 'mouseleave', focus: 'blur', click: 'click', touch: 'touchend', pointer: 'pointerup' }
function nt(e, t) {
  const o = e.indexOf(t)
  o !== -1 && e.splice(o, 1)
}
  ...
  zt = () =>
    Te({
      ...
      props: {
        ...
        placement: { type: String, default: y('placement'), validator: e => Ot.includes(e) },
        ...
        container: { type: [String, Object, De, Boolean], default: y('container') },
        boundary: { type: [String, De], default: y('boundary') },
        strategy: { type: String, validator: e => ['absolute', 'fixed'].includes(e), default: y('strategy') },
      ...
      methods: {
        show({ event: e = null, skipDelay: t = !1, force: o = !1 } = {}) {
          var i, n
          ;((i = this.parentPopper) != null && i.lockedChild && this.parentPopper.lockedChild !== this) ||
            ((this.pendingHide = !1),
            (o || !this.disabled) &&
        ...
        async $_computePosition() {
          ...
          ;(this.distance || this.skidding) &&
            e.middleware.push(mo({ mainAxis: this.distance, crossAxis: this.skidding }))
          const t = this.placement.startsWith('auto')
          if (
            (t
              ? e.middleware.push(ho({ alignment: this.placement.split('-')[1] ?? '' }))
              : (e.placement = this.placement),
            this.preventOverflow &&
              (this.shift &&
                e.middleware.push(
                  go({ padding: this.overflowPadding, boundary: this.boundary, crossAxis: this.shiftCrossAxis }),
                ),
              !t && this.flip && e.middleware.push(uo({ padding: this.overflowPadding, boundary: this.boundary }))),
            e.middleware.push(po({ element: this.$_arrowNode, padding: this.arrowPadding })),
            this.arrowOverflow &&
              e.middleware.push({
                name: 'arrowOverflow',
            ...
            e.middleware.push({
              ...
              fn: ({ rects: n, placement: s, middlewareData: r }) => {
                ...
                let l, d
                return (
                  s.startsWith('top') || s.startsWith('bottom') ? (l = n.reference.width) : (d = n.reference.height),
                  (this.$_innerNode.style[i === 'min' ? 'minWidth' : i === 'max' ? 'maxWidth' : 'width'] =
                    l != null ? `${l}px` : null),
                  (this.$_innerNode.style[i === 'min' ? 'minHeight' : i === 'max' ? 'maxHeight' : 'height'] =
                    d != null ? `${d}px` : null),
          ...
          const o = await _o(this.$_referenceNode, this.$_popperNode, e)
        ...
        $_isAimingPopper() {
          ...
          if (se >= e.left && se <= e.right && re >= e.top && re <= e.bottom) {
            const t = this.$_popperNode.getBoundingClientRect(),
              o = se - V,
              i = re - q,
              n = t.left + t.width / 2 - V + (t.top + t.height / 2) - q + t.width + t.height,
              s = V + o * n,
              r = q + i * n
            return (
              me(V, q, s, r, t.left, t.top, t.left, t.bottom) ||
              me(V, q, s, r, t.left, t.top, t.right, t.top) ||
              me(V, q, s, r, t.right, t.top, t.right, t.bottom) ||
...
function at(e, t) {
  if (N.autoHideOnMousedown) kt(e, t)
  else
...
function dt(e, t, o) {
  return o.closeAllPopover || (o.closePopover && t) || (bo(e, o) && !t)
}
function bo(e, t) {
...
function So(e, t, o, i, n, s) {
  return (
    I(),
    le(
      'div',
      { ref: 'reference', class: Ie(['v-popper', { 'v-popper--shown': e.slotData.isShown }]) },
      [we(e.$slots, 'default', Kt(Zt(e.slotData)))],
      2,
    )
  )
}
const Po = Oe(To, [['render', So]])
function Ao() {
...
const Co = Yt()
Vt('data-v-b329ee4c')
const Oo = { class: 'resize-observer', tabindex: '-1' }
qt()
const zo = Co((e, t, o, i, n, s) => (I(), Se('div', Oo)))
ze.render = zo
...
const Nt = (e = 'theme') => ({
  ...
  Lo = ['id', 'aria-hidden', 'tabindex', 'data-popper-placement'],
  No = { ref: 'inner', class: 'v-popper__inner' },
  Mo = Z('div', { class: 'v-popper__arrow-outer' }, null, -1),
  Ho = Z('div', { class: 'v-popper__arrow-inner' }, null, -1),
  Ro = [Mo, Ho]
function Bo(e, t, o, i, n, s) {
  ...
  return (
    ...
    le(
      ...
      [
        Z('div', { class: 'v-popper__backdrop', onClick: t[0] || (t[0] = a => e.autoHide && e.$emit('hide')) }),
        Z(
          'div',
          { class: 'v-popper__wrapper', style: ke(e.result ? { transformOrigin: e.result.transformOrigin } : void 0) },
          [
            Z(
              'div',
              No,
                ...
                e.mounted
                  ? (I(),
                    le(
                      ...
                      { key: 0 },
                      [
                        Z('div', null, [we(e.$slots, 'default')]),
                        e.handleResize
                          ? (I(), Se(r, { key: 0, onNotify: t[1] || (t[1] = a => e.$emit('resize', a)) }))
                          : Ge('', !0),
                      ],
                      64,
                    ))
            ...
            Z(
              'div',
              {
                ...
                style: ke(e.result ? { left: e.toPx(e.result.arrow.x), top: e.toPx(e.result.arrow.y) } : void 0),
              },
              Ro,
              4,
            ),
...
const Do = Te({
  name: 'VPopperWrapper',
  components: { Popper: Po, PopperContent: Mt },
  mixins: [Ht, Nt('finalTheme')],
  props: {
    ...
    container: { type: [String, Object, Fe, Boolean], default: void 0 },
    boundary: { type: [String, Fe], default: void 0 },
      ...
      }),
      {
        default: ve(
          ({
            ...
            we(e.$slots, 'default', { shown: d, show: h, hide: f }),
            ft(
              r,
              {
                ref: 'popperContent',
              ...
              { default: ve(() => [we(e.$slots, 'popper', { shown: d, hide: f })]), _: 2 },
              1032,
              [
                'popper-id',
                'theme',
...
const qe = Oe(Do, [['render', Eo]]),
  Fo = { ...qe, name: 'VDropdown', vPopperTheme: 'dropdown' },
  Rt = { ...qe, name: 'VMenu', vPopperTheme: 'menu' },
  Io = { ...qe, name: 'VTooltip', vPopperTheme: 'tooltip' },
  jo = Te({
    name: 'VTooltipDirective',
    components: { Popper: zt(), PopperContent: Mt },
    mixins: [Ht],
    inheritAttrs: !1,
    props: {
        ...
        default: ve(
          ({
            ...
            ft(
              ...
              {
                ref: 'popperContent',
                class: Ie({ 'v-popper--tooltip-loading': e.loading }),
                'popper-id': l,
                theme: e.theme,
                shown: d,
                mounted: c,
              ...
              },
              {
                default: ve(() => [
                  e.html
                    ? (I(), le('div', { key: 0, innerHTML: e.finalContent }, null, 8, Wo))
                    : (I(), le('div', { key: 1, textContent: eo(e.finalContent) }, null, 8, Vo)),
                ]),
                _: 2,
              },
              1032,
...
const Go = Oe(jo, [['render', qo]]),
  Bt = 'v-popper--has-tooltip'
function Yo(e, t) {
  let o = e.placement
...
function Ko(e, t, o) {
  ...
  const i = He(Dt(e, t, o)),
    n = He(!1),
    s = { id: Xo++, options: i, shown: n }
  return (
    ue.value.push(s),
    e.classList && e.classList.add(Bt),
    (e.$_popper = {
      options: i,
      item: s,
      show() {
...
function Jo(e, t = {}) {
  e.$_vTooltipInstalled ||
    ...
    At(N, t),
    e.directive('tooltip', Zo),
    e.directive('close-popper', Qo),
    e.component('VTooltip', Io),
    e.component('VDropdown', Fo),
    e.component('VMenu', Rt))
}
const ei = { version: '5.2.2', install: Jo, options: N },
  ut =
    typeof navigator < 'u' &&
    ...
    install: (e, t = {}) => {
      ;(typeof window < 'u' &&
        window.addEventListener(
          'click',
          o => {
            o.composedPath().some(n => {
              var s, r, a, l
              return (
                ((r = (s = n == null ? void 0 : n.classList) == null ? void 0 : s.contains) == null
                  ? void 0
                  : r.call(s, 'vp-code-group')) ||
                ((l = (a = n == null ? void 0 : n.classList) == null ? void 0 : a.contains) == null
                  ? void 0
                  : l.call(a, 'tabs'))
              )
            }) && Lt()
        ...
        e.use(ei, {
          ...
          themes: {
            twoslash: {
              $extend: 'dropdown',
              triggers: ut ? ['touch'] : ['hover', 'touch'],
              popperTriggers: ut ? ['touch'] : ['hover', 'touch'],
            ...
            'twoslash-query': { $extend: 'twoslash', triggers: ['click'], popperTriggers: ['click'], autoHide: !1 },
            'twoslash-completion': {
