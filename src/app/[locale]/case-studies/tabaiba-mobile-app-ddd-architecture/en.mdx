...
export const metadata = {
  title: 'Tabaiba — Building a High-Quality Mobile App with DDD',
  slug: 'tabaiba',
  date: '2025-03-15',
  image: 'tabaiba.jpg',
  summary:
    'A mobile application that offers three carefully selected new people to meet every Friday, focusing on authentic and intentional social connections.',
}
