...
export const metadata = {
  title: 'Lightspace — Shopify Apps with Best Practices',
  slug: 'lightspace',
  date: '2025-08-11',
  image: 'lightspace.png',
  summary:
    'How I helped Lightspace develop Shopify Apps and Functions using best practices, created templates for scalable development, and implemented CI/CD pipelines for testing and deployment.',
}
